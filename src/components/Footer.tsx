      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <address className="not-italic text-muted-foreground space-y-3">
              <p>Children's Dental Center</p>
              <p>BPKHS, Dharan, Nepal</p>
              <p>
                <a href="mailto:dr.smile@pediatricdental.com" className="hover:text-dental-blue transition-colors duration-200">
                  dr.smile@pediatricdental.com
                </a>
              </p>
              <p>
                <a href="tel:+9779812345678" className="hover:text-dental-blue transition-colors duration-200">
                  +977 9812345678
                </a>
              </p>
            </address>
        ...
        <div className="border-t border-dental-blue/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {new Date().getFullYear()} Dr. Smile. All rights reserved.
          </p>
